...
export const AuthorInfoBar = () => {
    return (
        <div
         className="max-w-[1300px] mx-auto px-2">
          <div
          ...
          >
            ...
            <div className="w-[55%] py-10">
              <h1 className="xl:text-4xl text-3xl mt-[60px] font-bold text-[#ffffffda]">
                Junior Front-End Developer <br /> from Slovakia.
              </h1>
              <p className="xl:text-2xl text-xl w-[85%] mt-[10px] text-[#ffffff83]">
...
// ! tu sa bude musiet pridat hook na kontrolu width a spravit 2. element kde bude obrazok na spodku a text nad nim